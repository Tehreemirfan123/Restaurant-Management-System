...
export default function CustomerHeader() {
    ...
    return (
        <header className="bg-maroon-700 text-white px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <Link to="/" className="flex flex-col">
                <span className="text-xl font-bold leading-tight">
                    Mehak&apos;s Kitchen
                </span>
                <span className="text-gold-100 text-xs">Order online</span>
            </Link>
            ...
            <div className="flex items-center gap-4">
                ...
                <Link
                    to="/login"
                    className="text-sm text-gold-100 hover:text-white"
                >
                    Staff
                </Link>
            </div>
